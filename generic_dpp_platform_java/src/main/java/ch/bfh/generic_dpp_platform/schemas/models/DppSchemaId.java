...
public class DppSchemaId {
    ...
    @Column(name = "subject_type_name", nullable = false)
    private String subjectTypeName;

    public boolean invalid() {
        return majorVersion == null || minorVersion == null || subjectTypeName == null
                || majorVersion <= 0 || minorVersion < 0;
    }

    @Override
    public String toString() {
        return String.format("%s v%s.%s", subjectTypeName, majorVersion, minorVersion);
    }
}
