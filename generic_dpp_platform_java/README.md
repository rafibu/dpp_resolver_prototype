...
Both endpoints bind Java-style query parameters. Predicate requests use
`resultMode`, `executionMode`, and `subjectType`; filters use
`filters[0].path`, `filters[0].operator`, and `filters[0].value`; repeated
