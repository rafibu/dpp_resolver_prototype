...
from dpp_platform_factory.api.api import app, get_docker_client, get_schema_seed_service, get_platform_service, state, spawn_lock, default_platform_ids
...
def client(fake_docker, fake_resolver, test_state):
    ...
    def get_fake_platform_service():
        return PlatformService(
            ...
            resolver_client_factory=lambda url: fake_resolver
        )
